...
import im1 from "./commonResource/images/icons/16.png";
function Footer() {
  return (
    <footer className="footer-wrapper">
      <div className="container">
        <div className="upper-text-container">
          <p>
            1. Trade In: Trade_in values vary. iPhone 11 and iPhone 11 Pro
            promotional pricing is after trade_in of iPhone 8 Plus and iPhone X
            in good condition. Additional trade_in values require purchase of a
            ...
            any Trade In transaction for any reason. In_store trade_in requires
            ...
            value of new iPhone. Additional terms from Apple or Apples trade-in
